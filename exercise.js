...
var longestPlace = longestPlaceName + " is the longest place name in the world and has " + howManyLetters + " letters in its name."
...
var theSifu = grasshopper.replace("first fill your cup.", "empty your cup.");
console.log(theSifu);
